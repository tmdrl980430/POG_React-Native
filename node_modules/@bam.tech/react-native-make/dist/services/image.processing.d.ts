...
export declare const generateResizedAssetsWithoutAlpha: (sourcePath: string, destinationPath: string, width: number, height?: number, options?: sharp.ResizeOptions) => Promise<sharp.OutputInfo>;
